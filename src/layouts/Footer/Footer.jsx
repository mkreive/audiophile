...
import { Logo, Navigation, Paragraph } from 'components';
      ...
      <div className={cn('container-wrapper')}>
        ...
        <div className={cn('content')}>
          <div className={cn('content--left')}>
            ...
            <Paragraph theme='gray--bold'>Copyright {date}. All Rights Reserved</Paragraph>
          </div>
          <div className={cn('content--right')}>
            <a href='https://www.facebook.com' className={cn('icon')}>
            ...
            <a href='https://www.twiter.com' className={cn('icon')}>
            ...
            <a href='https://www.instagram.com' className={cn('icon')}>
              <svg width='24' height='24' xmlns='http://www.w3.org/2000/svg'>
                <path
